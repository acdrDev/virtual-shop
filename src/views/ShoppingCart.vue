          ...
          <div class="w-full p-4 px-5 py-5">
            <div class="md:grid md:grid-cols-3 gap-2">
              <div class="col-span-2 p-5">
                ...
                <ProductCart v-for="product in cart" v-bind:key="product.id" :image="host+'upload/'+product.image" :name="product.title" :description="product.description" :price="product.price" />
                ...
                >
                  <div class="flex items-center">
                    <router-link to="/categorias"
                      ><i class="fas fa-arrow-left text-sm text-secundary pr-2"></i>
              ...
              <div class="p-5 bg-gray-800 rounded overflow-visible">
                ...
                <div class="grid grid-cols-3 gap-2 pt-2 mb-3">
                  <div class="col-span-2">
                    <label class="text-xs text-gray-400">Fecha de expiración</label>
